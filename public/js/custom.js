...
$(function() {
 "use strict";
  ...
  $( window ).on( "load", function() {
    ...
    //Disable Right Mouse Click/keyboard Start
    ...
    //Disable Right Mouse Click/keyboard End
  });

  function loginc(){
    a= $('#txtusr').val();
    b=$('#txtpas').val();
    //alert("Button pressed"+" "+a+" "+b);
    $.post("/logins",{username:a,password:b},(res,status)=>{
      alert("*----Received Data----*nnResponse : " + res+"nnStatus : " + status);
      $('#txtusr').val('');
      $('#txtpas').val('');
    });
  }
